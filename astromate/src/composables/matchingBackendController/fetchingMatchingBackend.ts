...
import useAuthentication from "@/composables/authentication/authentication";
        ...
        if(token === ''){
            ...
            try {
                const response = await axios.get<GroupsResponse>(URI + "getOtherGroups/" +
                    ...
                    groupsFilter.category,{headers:{"Authorization":token}}  /*,{headers:{"ngrok-skip-browser-warning":"1"}}*/);
